...
const int nmax = 1e6+10;//1≤n,q≤106

int tree[4*nmax]; // we don't need to use long long here as values are small
int arr[nmax]; // we don't need to use long long here as values are small
